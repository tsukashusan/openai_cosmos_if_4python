...
$AZURE_OPENAI_MODEL_FOR_DDOC_SEARCH="<AZURE_OPENAI_MODEL_FOR_DDOC_SEARCH>"
$MAX_TOKEN=4096
...
az webapp config appsettings set --resource-group demo1 --name $functionName --settings AZURE_OPENAI_MODEL_FOR_DDOC_SEARCH=$AZURE_OPENAI_MODEL_FOR_DDOC_SEARCH
