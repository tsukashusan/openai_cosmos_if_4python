...
az functionapp config appsettings set --resource-group $resourceGroupName --name $functionName --settings AZURE_OPENAI_MODEL_FOR_EMBEDDING_NAME=$AZURE_OPENAI_MODEL_FOR_EMBEDDING_NAME
az functionapp config appsettings set --resource-group $resourceGroupName --name $functionName --settings AZURE_OPENAI_MODEL_FOR_EMBEDDING_API=$AZURE_OPENAI_MODEL_FOR_EMBEDDING_API
...
az functionapp config appsettings set --resource-group $resourceGroupName --name $functionName --settings BLOB_CONTAINER_INDEX=$BLOB_CONTAINER_INDEX
az functionapp config appsettings set --resource-group $resourceGroupName --name $functionName --settings BLOB_PATH_START_INDEX=$BLOB_PATH_START_INDEX
az functionapp config appsettings set --resource-group $resourceGroupName --name $functionName --settings DEBUG_MODE=$DEBUG_MODE
